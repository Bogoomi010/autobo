...
const quickBuyAmounts = [10_000, 50_000, 100_000];
...
function App() {
  ...
  const quoteCurrency = normalizedMarket.split("-")[0] ?? "";
  const baseCurrency = normalizedMarket.split("-")[1] ?? "";
  ...
  const canEstimateVolume = Boolean(ticker?.trade_price && ticker.trade_price > 0);
